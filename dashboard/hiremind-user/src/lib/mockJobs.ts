...
export const MOCK_JOBS: JobApplication[] = [
  ...
  ...Array.from({ length: 10 }, (_, i) => {
    ...
    return {
      ...
      referral: i % 3 === 0,
      appliedTime: `2026/03/${22 + i} 10:00`,
      resumeUrl: '#',
      coverLetterUrl: '#',
      notes: [],
  ...
  ...Array.from({ length: 8 }, (_, i) => {
    ...
    return {
      ...
      referral: i % 2 === 0,
      appliedTime: `2026/03/${15 + i} 09:00`,
      resumeUrl: '#',
      coverLetterUrl: '#',
      notes: [{ id: `n-scr-${i}`, content: 'Recruiter screen scheduled.', timestamp: '2026/04/02', type: 'call' as const }],
      tags: ['Follow-up'],
      jobDescription: getMockDescription(jobTitle),
      interviewTimeline: [],
